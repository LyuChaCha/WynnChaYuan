...
/**
 * 貢獻者名單，讀自 {@code assets/wynncollect/credits.json}。
 *
...
public final class Credits {
    ...
    public static List<CreditsScreen.Section> sections() {
        ...
        try (InputStream in = Credits.class.getResourceAsStream("/assets/wynncollect/credits.json")) {
            if (in != null) {
            ...
            System.err.println("[WynnCollect] 貢獻者名單讀取失敗: " + e.getMessage());
        }
