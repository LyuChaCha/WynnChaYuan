...
| 語言 | 進度 | 已翻 / 總數 |
|---|---|---:|
| `zh_tw` 繁體中文 | █████████░ 91.9% | 38,455 / 41,831 |
| `zh_cn` 简体中文 | ██░░░░░░░░ 20.0% | 5,744 / 28,770 |
...
| NPC nameplates, menus, system messages | 11,537 | 14,806 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 49,991 lines estimated**, **41,831 collected** (84%), **38,455 translated** (77% of the estimate, 91.9% of what we have).
...
| NPC 名牌、介面、系統訊息 | 11,537 | 14,806 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 49,991 句**，已收集 **41,831 句**（84%），已翻譯 **38,455 句**（佔預估的 77%、佔已收集的 91.9%）。
