...
|---|---:|---:|---:|---|
| 任務對話 | 22,374 | 22,562 | 22,562 | 157/157 個任務都收齊了，收到的就是全部 |
...
| NPC 名牌、介面、系統訊息 | 9,996 | 14,234 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 49,531 句**，已收集 **41,371 句**（84%），已翻譯 **36,739 句**（佔預估的 74%、佔已收集的 88.8%）。
