...
| 語言 | 進度 | 已翻 / 總數 |
|---|---|---:|
| `zh_cn` 简体中文 | █████████░ 93.7% | 39,841 / 42,529 |
| `ja_jp` 日本語 | █████████░ 93.5% | 39,758 / 42,529 |
| `zh_tw` 繁體中文 | █████████░ 92.7% | 40,119 / 43,255 |
| `ru_ru` Русский | ████░░░░░░ 40.8% | 17,335 / 42,529 |
...
| NPC nameplates, menus, system messages | — | 5,048 + 1,055 collected | **No official list** - only what players run into |
...
|---|---:|---:|---:|---|
| Quest dialogue | 22,592 | 22,671 | 22,671 | all 157/157 quests collected - what we have is all there is |
...
| NPC nameplates, menus, system messages | 13,010 | 16,003 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 51,415 lines estimated**, **43,255 collected** (84%), **40,119 translated** (78% of the estimate, 92.7% of what we have).
...
| 技能樹 | ██████████ | 全部 | 官方 CDN，整批下載 |
| NPC 名牌、介面、系統訊息 | — | 已收 5,048 + 1,055 條 | **沒有官方清單**，只能靠玩家遇到 |
...
|---|---:|---:|---:|---|
| 任務對話 | 22,592 | 22,671 | 22,671 | 157/157 個任務都收齊了，收到的就是全部 |
...
| NPC 名牌、介面、系統訊息 | 13,010 | 16,003 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 51,415 句**，已收集 **43,255 句**（84%），已翻譯 **40,119 句**（佔預估的 78%、佔已收集的 92.7%）。
