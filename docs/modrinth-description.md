...
| 技能樹 | ██████████ | 全部 | 官方 CDN，整批下載 |
| NPC 名牌、介面、系統訊息 | — | 已收 4,731 + 1,050 條 | **沒有官方清單**，只能靠玩家遇到 |
...
| NPC 名牌、介面、系統訊息 | 11,683 | 15,076 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 50,292 句**，已收集 **42,132 句**（84%），已翻譯 **38,642 句**（佔預估的 77%、佔已收集的 91.7%）。
