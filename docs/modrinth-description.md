...
| NPC nameplates, menus, system messages | 11,223 | 14,659 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 49,805 lines estimated**, **41,645 collected** (84%), **38,111 translated** (77% of the estimate, 91.5% of what we have).
...
| NPC 名牌、介面、系統訊息 | 11,223 | 14,659 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 49,805 句**，已收集 **41,645 句**（84%），已翻譯 **38,111 句**（佔預估的 77%、佔已收集的 91.5%）。
