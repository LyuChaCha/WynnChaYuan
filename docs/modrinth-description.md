...
| NPC nameplates, menus, system messages | — | 5,043 + 1,055 collected | **No official list** - only what players run into |
...
|---|---:|---:|---:|---|
| Quest dialogue | 22,592 | 22,680 | 22,680 | all 157/157 quests collected - what we have is all there is |
...
| NPC nameplates, menus, system messages | 13,009 | 15,955 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 51,376 lines estimated**, **43,216 collected** (84%), **40,118 translated** (78% of the estimate, 92.8% of what we have).
...
| 技能樹 | ██████████ | 全部 | 官方 CDN，整批下載 |
| NPC 名牌、介面、系統訊息 | — | 已收 5,043 + 1,055 條 | **沒有官方清單**，只能靠玩家遇到 |
...
|---|---:|---:|---:|---|
| 任務對話 | 22,592 | 22,680 | 22,680 | 157/157 個任務都收齊了，收到的就是全部 |
...
| NPC 名牌、介面、系統訊息 | 13,009 | 15,955 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 51,376 句**，已收集 **43,216 句**（84%），已翻譯 **40,118 句**（佔預估的 78%、佔已收集的 92.8%）。
