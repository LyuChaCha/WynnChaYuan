...
| 內容 | 句數 | 檔案 |
|---|---:|---|
| misc.json | 6,072 | [`misc.json`](../src/main/resources/assets/wynnchayuan/translations/zh_tw/misc.json) |
| npc.json | 4,839 | [`npc.json`](../src/main/resources/assets/wynnchayuan/translations/zh_tw/npc.json) |
