...
| `npc.json` | ██████░░░░ 55% | 651 / 1,178 | 走在城裡就會看到<br>NPC names, seen while walking around town |
| `gui.json` | ██████████ 99% | 944 / 953 | 選單與介面<br>Menus and interface text |
...
| `quest-dialogue.json` | ██████████ 100% | 22,135 / 22,135 | 任務對話<br>NPC dialogue (by far the largest file) |
