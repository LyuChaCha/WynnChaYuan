...
| `misc.json` | ███████░░░ 74% | 4,918 / 6,662 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
...
| `quest.json` | ██████████ 99% | 517 / 522 | 任務介面<br>The quest interface |
...
| `quest-dialogue.json` | ██████████ 100% | 22,796 / 22,830 | 任務對話<br>NPC dialogue (by far the largest file) |
...
|---|---|---:|---|
| `ui-labels.json` | ██████████ 100% | 290 / 290 | 每次看物品都會看到（力量、戰鬥等級…）<br>Seen on every item tooltip (Strength, Combat Level, ...) |
| `misc.json` | ██████░░░░ 59% | 3,657 / 6,182 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
