...
| `misc.json` | ██████░░░░ 56% | 3,495 / 6,276 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
| `label.json` | ██████████ 100% | 313 / 313 | 浮在世界裡的字（工作站、互動提示）<br>Text floating in the world (stations, interaction prompts) |
| `npc.json` | ██████████ 98% | 4,834 / 4,927 | 走在城裡就會看到<br>NPC names, seen while walking around town |
...
| `quest.json` | ████████░░ 84% | 347 / 412 | 任務介面<br>The quest interface |
...
| `quest-dialogue.json` | ██████████ 100% | 22,506 / 22,599 | 任務對話<br>NPC dialogue (by far the largest file) |
