...
| `misc.json` | █████░░░░░ 49% | 2,751 / 5,667 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
| `label.json` | ██████████ 100% | 313 / 313 | 浮在世界裡的字（工作站、互動提示）<br>Text floating in the world (stations, interaction prompts) |
| `npc.json` | ██████████ 96% | 4,340 / 4,513 | 走在城裡就會看到<br>NPC names, seen while walking around town |
...
| `quest.json` | ██████████ 100% | 265 / 266 | 任務介面<br>The quest interface |
...
| `quest-dialogue.json` | ██████████ 100% | 22,401 / 22,401 | 任務對話<br>NPC dialogue (by far the largest file) |
...
| `wynntils.json` | ██████████ 100% | 31 / 31 | Wynntils 自己的介面字串<br>Wynntils' own interface strings |
| `gear-*.json` | ██░░░░░░░░ 22% | 222 / 990 | 裝備的傳說敘述（名稱是專有名詞，不計入）<br>Gear lore (names stay in English, not counted) |
