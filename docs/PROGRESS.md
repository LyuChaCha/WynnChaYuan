...
| `misc.json` | █████░░░░░ 46% | 2,625 / 5,671 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
...
| `ability/*.json` | █████████░ 92% | 1,453 / 1,574 | 開技能樹時<br>Ability tree |
...
| `quest-dialogue.json` | ██████████ 100% | 22,383 / 22,383 | 任務對話<br>NPC dialogue (by far the largest file) |
