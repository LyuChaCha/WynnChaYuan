...
| `misc.json` | ███████░░░ 73% | 4,984 / 6,842 | 物品說明、粉末、交易市場的零碎字串<br>Item lore, powders, and the trade market's odds and ends |
| `label.json` | ██████████ 100% | 317 / 317 | 浮在世界裡的字（工作站、互動提示）<br>Text floating in the world (stations, interaction prompts) |
| `npc.json` | ██████████ 96% | 5,187 / 5,395 | 走在城裡就會看到<br>NPC names, seen while walking around town |
...
| `quest-dialogue.json` | ██████████ 100% | 22,838 / 22,895 | 任務對話<br>NPC dialogue (by far the largest file) |
