...
|---|---:|---:|---:|---|
| Quest dialogue | 22,371 | 22,405 | 22,405 | all 157/157 quests collected - what we have is all there is |
...
| NPC nameplates, menus, system messages | 11,223 | 14,658 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 49,804 lines estimated**, **41,644 collected** (84%), **38,111 translated** (77% of the estimate, 91.5% of what we have).
...
|---|---:|---:|---:|---|
| 任務對話 | 22,371 | 22,405 | 22,405 | 157/157 個任務都收齊了，收到的就是全部 |
...
| NPC 名牌、介面、系統訊息 | 11,223 | 14,658 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 49,804 句**，已收集 **41,644 句**（84%），已翻譯 **38,111 句**（佔預估的 77%、佔已收集的 91.5%）。
