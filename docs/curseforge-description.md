...
| 語言 | 進度 | 已翻 / 總數 |
|---|---|---:|
| `zh_tw` 繁體中文 | █████████░ 92.8% | 39,778 / 42,882 |
| `zh_cn` 简体中文 | █████████░ 91.8% | 39,058 / 42,529 |
...
| NPC nameplates, menus, system messages | — | 4,927 + 1,055 collected | **No official list** - only what players run into |
...
|---|---:|---:|---:|---|
| Quest dialogue | 22,506 | 22,599 | 22,599 | all 157/157 quests collected - what we have is all there is |
...
| NPC nameplates, menus, system messages | 12,755 | 15,702 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 51,042 lines estimated**, **42,882 collected** (84%), **39,778 translated** (78% of the estimate, 92.8% of what we have).
...
| 技能樹 | ██████████ | 全部 | 官方 CDN，整批下載 |
| NPC 名牌、介面、系統訊息 | — | 已收 4,927 + 1,055 條 | **沒有官方清單**，只能靠玩家遇到 |
...
|---|---:|---:|---:|---|
| 任務對話 | 22,506 | 22,599 | 22,599 | 157/157 個任務都收齊了，收到的就是全部 |
...
| NPC 名牌、介面、系統訊息 | 12,755 | 15,702 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 51,042 句**，已收集 **42,882 句**（84%），已翻譯 **39,778 句**（佔預估的 78%、佔已收集的 92.8%）。
