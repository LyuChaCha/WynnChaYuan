...
> All together: **at least 49,486 lines estimated**, **41,326 collected** (84%), **38,107 translated** (77% of the estimate, 92.2% of what we have).
...
> 全部加起來：**預估至少 49,486 句**，已收集 **41,326 句**（84%），已翻譯 **38,107 句**（佔預估的 77%、佔已收集的 92.2%）。
