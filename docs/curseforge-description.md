...
| 語言 | 進度 | 已翻 / 總數 |
|---|---|---:|
| `zh_tw` 繁體中文 | █████████░ 92.7% | 39,439 / 42,544 |
| `zh_cn` 简体中文 | █████████░ 91.8% | 39,058 / 42,544 |
| `ja_jp` 日本語 | ███░░░░░░░ 30.9% | 13,126 / 42,544 |
...
| NPC nameplates, menus, system messages | 12,416 | 15,450 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 50,704 lines estimated**, **42,544 collected** (84%), **39,439 translated** (78% of the estimate, 92.7% of what we have).
...
| NPC 名牌、介面、系統訊息 | 12,416 | 15,450 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 50,704 句**，已收集 **42,544 句**（84%），已翻譯 **39,439 句**（佔預估的 78%、佔已收集的 92.7%）。
