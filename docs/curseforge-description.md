...
| 技能樹 | ██████████ | 全部 | 官方 CDN，整批下載 |
| NPC 名牌、介面、系統訊息 | — | 已收 4,012 + 1,050 條 | **沒有官方清單**，只能靠玩家遇到 |
...
| NPC 名牌、介面、系統訊息 | 9,996 | 13,885 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 48,994 句**，已收集 **40,834 句**（83%），已翻譯 **36,739 句**（佔預估的 75%、佔已收集的 90.0%）。
