...
| NPC nameplates, menus, system messages | 11,277 | 14,655 | — | **no list exists** - only what players run into; cannot be estimated |

> All together: **at least 49,801 lines estimated**, **41,641 collected** (84%), **38,165 translated** (77% of the estimate, 91.7% of what we have).
...
| NPC 名牌、介面、系統訊息 | 11,277 | 14,655 | — | **沒有清單**，只能靠玩家遇到；估不出來 |

> 全部加起來：**預估至少 49,801 句**，已收集 **41,641 句**（84%），已翻譯 **38,165 句**（佔預估的 77%、佔已收集的 91.7%）。
