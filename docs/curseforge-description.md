...
Code: [GNU AGPLv3](https://github.com/LyuChaCha/WynnChaYuan/blob/main/LICENSE). Translations and data: [CC BY-NC-SA 4.0](https://github.com/LyuChaCha/WynnChaYuan/blob/main/LICENSE-DATA). Item and ability data come from the public CDN used by Wynntils. Dialogue-box glyphs use Fusion Pixel (SIL OFL 1.1).
...
程式碼：[GNU AGPLv3](https://github.com/LyuChaCha/WynnChaYuan/blob/main/LICENSE)；翻譯與資料：[CC BY-NC-SA 4.0](https://github.com/LyuChaCha/WynnChaYuan/blob/main/LICENSE-DATA)。物品與技能資料取自 Wynntils 使用的公開 CDN；對話框字形使用 Fusion Pixel（SIL OFL 1.1）。
