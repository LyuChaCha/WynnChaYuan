...
| NPC 名牌 | 注視時在準心下方跳一個小框 |
| 任務追蹤 | 畫面左側的獨立小框 |
| 技能樹 | 每個節點、說明與流派 |
| 譯文截圖 | **F8** 把翻譯面板拍下來，複製到剪貼簿或存成檔案 |
...
| 語言 | 進度 | 已翻 / 總數 |
|---|---|---:|
| `zh_tw` 繁體中文 | ███░░░░░░░ 30.9% | 8,278 / 26,827 |
| `de_de` Deutsch | ░░░░░░░░░░ 0.0% | 0 / 26,819 |
| `es_es` Español | ░░░░░░░░░░ 0.0% | 0 / 26,819 |
| `fr_fr` Français | ░░░░░░░░░░ 0.0% | 0 / 26,819 |
| `ja_jp` 日本語 | ░░░░░░░░░░ 0.0% | 0 / 26,819 |
...
- 對話框裡的中日韓字形使用 [Ark Pixel 10px](https://github.com/TakWolf/ark-pixel-font)
  比例模式（SIL OFL 1.1，授權全文見 `assets/wynnchayuan/font/OFL-ark-pixel.txt`）。
