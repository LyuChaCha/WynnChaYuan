...
<!-- 進度:開始 -->
**繁體中文（zh_tw）進度 8,270 / 26,819（30.8%）**，更新於 2026-08-27。

各語言：`zh_cn` 0.0%　·　`zh_tw` 30.8%

| 檔案 | 進度 | 已翻 / 總數 | 什麼時候會看到 |
|---|---|---:|---|
| `ui-labels.json` | ██████████ 100% | 288 / 288 | 每次看物品都會看到（力量、戰鬥等級…） |
| `npc.json` | ██████░░░░ 57% | 125 / 220 | 走在城裡就會看到 |
| `gui.json` | ██████████ 98% | 507 / 516 | 選單與介面 |
| `quest.json` | ░░░░░░░░░░ 1% | 1 / 116 | 任務名稱與任務介面 |
| `ability/*.json` | █████████░ 91% | 810 / 889 | 開技能樹時 |
| `major-id.json` | ██████████ 100% | 322 / 322 | 傳奇裝備的特殊詞條 |
| `quest-dialogue.json` | ██░░░░░░░░ 17% | 3,842 / 22,089 | 任務對話 |
| `ingredient.json` | ██████████ 100% | 969 / 969 | 做職業時 |
| `material.json` | ██████████ 100% | 136 / 136 | 做職業時 |
| `tome.json` | ██████████ 100% | 156 / 156 | 書卷 |
| `aspect.json` | ██████████ 100% | 128 / 128 | Raid 的 Aspect |
| `gear-*.json` | ██████████ 100% | 986 / 990 | 裝備的傳說敘述（名稱是專有名詞，不計入） |
| **合計** | ███░░░░░░░ **30.8%** | **8,270 / 26,819** | |
<!-- 進度:結束 -->
